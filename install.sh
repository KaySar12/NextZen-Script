...
Check_Arch() {
    ...
    *)
    ...
    NEXTZEN_PACKAGES=(
        ...
        "${NEXTZEN_DOWNLOAD_DOMAIN}KaySar12/CasaOS/releases/download/test/linux-amd64-nextzen-v1.0.0.tar.gz"
        ...
        "${NEXTZEN_DOWNLOAD_DOMAIN}KaySar12/CasaOS-UI/releases/download/1.0.5/linux-all-nextzen-v1.0.8.tar.gz"
