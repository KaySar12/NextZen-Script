...
Check_Arch() {
    ...
    *)
    ...
    NEXTZEN_PACKAGES=(
        "${NEXTZEN_DOWNLOAD_DOMAIN}setup/nextzenos/1.1/Release/linux-amd64-nextzenos-gateway-v0.4.8-alpha2.tar.gz"
        "${NEXTZEN_DOWNLOAD_DOMAIN}setup/nextzenos/1.1/Release/linux-amd64-nextzenos-message-bus-v0.4.4-3-alpha2.tar.gz"
        "${NEXTZEN_DOWNLOAD_DOMAIN}setup/nextzenos/1.1/Release/linux-amd64-nextzenos-user-service-v0.4.8.tar.gz"
        "${NEXTZEN_DOWNLOAD_DOMAIN}setup/nextzenos/1.1/Release/linux-amd64-nextzenos-local-storage-v0.4.4.tar.gz"
        ...
        "${NEXTZEN_DOWNLOAD_DOMAIN}setup/nextzenos/1.1/Release/linux-amd64-nextzenos-cli-v0.4.4-3-alpha1.tar.gz"
        #Nextzen-UI
